...
-- Volcando estructura de base de datos para classicmodels
CREATE DATABASE IF NOT EXISTS `classicmodels` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `classicmodels`;

-- Volcando estructura para procedimiento classicmodels.clientes_con_mas_compras
DELIMITER //
...
-- Volcando estructura para tabla classicmodels.customers
...
-- Volcando datos para la tabla classicmodels.customers: ~122 rows (aproximadamente)
...
-- Volcando estructura para tabla classicmodels.customersEliminados
CREATE TABLE IF NOT EXISTS `customersEliminados` (
  ...
  `salesRepEmployeeNumber` int(11) DEFAULT NULL,
  `creditLimit` decimal(10,2) DEFAULT NULL,
  `fecha_de_eliminacion` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla classicmodels.customersEliminados: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `customersEliminados` DISABLE KEYS */;
/*!40000 ALTER TABLE `customersEliminados` ENABLE KEYS */;

-- Volcando estructura para tabla classicmodels.employees
...
-- Volcando datos para la tabla classicmodels.employees: ~23 rows (aproximadamente)
...
-- Volcando estructura para tabla classicmodels.exEmployees
...
-- Volcando datos para la tabla classicmodels.exEmployees: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `exEmployees` DISABLE KEYS */;
/*!40000 ALTER TABLE `exEmployees` ENABLE KEYS */;

-- Volcando estructura para tabla classicmodels.logProducto
...
-- Volcando datos para la tabla classicmodels.logProducto: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `logProducto` DISABLE KEYS */;
/*!40000 ALTER TABLE `logProducto` ENABLE KEYS */;

-- Volcando estructura para tabla classicmodels.offices
...
-- Volcando datos para la tabla classicmodels.offices: ~7 rows (aproximadamente)
...
-- Volcando estructura para procedimiento classicmodels.Ordenar_un_Producto
DELIMITER //
CREATE PROCEDURE `Ordenar_un_Producto`()
select * from products where productLine='Motorcycles'//
DELIMITER ;

-- Volcando estructura para tabla classicmodels.orderdetails
...
-- Volcando datos para la tabla classicmodels.orderdetails: ~2.996 rows (aproximadamente)
...
-- Volcando estructura para tabla classicmodels.orders
...
-- Volcando datos para la tabla classicmodels.orders: ~326 rows (aproximadamente)
...
-- Volcando estructura para tabla classicmodels.payments
...
-- Volcando datos para la tabla classicmodels.payments: ~273 rows (aproximadamente)
...
-- Volcando estructura para tabla classicmodels.productlines
...
-- Volcando datos para la tabla classicmodels.productlines: ~7 rows (aproximadamente)
...
-- Volcando estructura para tabla classicmodels.productlinesEliminados
CREATE TABLE IF NOT EXISTS `productlinesEliminados` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `productLine` varchar(50) NOT NULL,
  `textDescription` varchar(4000) DEFAULT NULL,
  `htmlDescription` mediumtext DEFAULT NULL,
...
-- Volcando datos para la tabla classicmodels.productlinesEliminados: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `productlinesEliminados` DISABLE KEYS */;
/*!40000 ALTER TABLE `productlinesEliminados` ENABLE KEYS */;

-- Volcando estructura para vista classicmodels.producto_mas_vendido
-- Creando tabla temporal para superar errores de dependencia de VIEW
CREATE TABLE `producto_mas_vendido` (
	`productName` VARCHAR(70) NOT NULL COLLATE 'latin1_swedish_ci',
	`productLine` VARCHAR(50) NOT NULL COLLATE 'latin1_swedish_ci',
	`total_ventas` DECIMAL(32,0) NULL,
	`total_compradores` BIGINT(21) NOT NULL
) ENGINE=MyISAM;

-- Volcando estructura para tabla classicmodels.products
...
-- Volcando datos para la tabla classicmodels.products: ~110 rows (aproximadamente)
...
-- Volcando estructura para tabla classicmodels.productsEliminados
CREATE TABLE IF NOT EXISTS `productsEliminados` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `productCode` varchar(15) NOT NULL,
  `productName` varchar(70) NOT NULL,
  `productLine` varchar(50) NOT NULL,
...
-- Volcando datos para la tabla classicmodels.productsEliminados: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `productsEliminados` DISABLE KEYS */;
/*!40000 ALTER TABLE `productsEliminados` ENABLE KEYS */;

-- Volcando estructura para disparador classicmodels.after_actualizar_products
...
-- Volcando estructura para disparador classicmodels.after_insertar_products
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
-- Volcando estructura para disparador classicmodels.before_customer_eliminar
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
-- Volcando estructura para disparador classicmodels.before_employee_eliminar
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
-- Volcando estructura para disparador classicmodels.Before_order_no_eliminar
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
-- Volcando estructura para disparador classicmodels.Before_payments_no_eliminar
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
-- Volcando estructura para disparador classicmodels.before_productline_eliminar
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
-- Volcando estructura para disparador classicmodels.before_product_eliminar
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION';
DELIMITER //
...
CREATE ALGORITHM=UNDEFINED SQL SECURITY DEFINER VIEW `classicmodels`.`producto_mas_vendido` AS select `p`.`productName` AS `productName`,`p`.`productLine` AS `productLine`,sum(`od`.`quantityOrdered`) AS `total_ventas`,count(distinct `c`.`customerNumber`) AS `total_compradores` from (((`classicmodels`.`products` `p` join `classicmodels`.`orderdetails` `od`) join `classicmodels`.`orders` `o`) join `classicmodels`.`customers` `c`) where `od`.`productCode` = `p`.`productCode` and `od`.`orderNumber` = `o`.`orderNumber` and `o`.`customerNumber` = `c`.`customerNumber` group by `p`.`productCode` order by sum(`od`.`quantityOrdered`) desc;
