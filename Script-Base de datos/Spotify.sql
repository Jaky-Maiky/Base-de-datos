...
CREATE TABLE IF NOT EXISTS `Album` (
  ...
  `Fecha_Lanzamiento` varchar(50) NOT NULL DEFAULT '',
...
CREATE TABLE `schema_auto_increment_columns` (
	`table_schema` VARCHAR(64) NOT NULL COLLATE 'utf8_bin',
...
CREATE TABLE `schema_object_overview` (
	`db` VARCHAR(64) NOT NULL COLLATE 'utf8_bin',
